...
g++ -O2 -mwindows -std=c++17 -o Elite_App_Marketplace-Server.v2.exe main.cpp miniz.o resource.res -lcomctl32 -lws2_32 -lwinhttp -lgdiplus -lole32 -static -static-libgcc -static-libstdc++
