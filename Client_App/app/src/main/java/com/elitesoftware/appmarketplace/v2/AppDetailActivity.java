...
public class AppDetailActivity extends AppCompatActivity {
    ...
    private BroadcastReceiver updateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Toast.makeText(context, "An update might be available for this app. Please refresh.", Toast.LENGTH_LONG).show();
            // Could re-fetch here if we had the direct URL or API
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            com.elitesoftware.appmarketplace.v2.EliteProgressBar detailProgressBar = findViewById(R.id.detailProgressBar);
            ...
            android.widget.LinearLayout detailTags = findViewById(R.id.detailTags);
            if (detailTags != null) {
                detailTags.removeAllViews();
                if (app.has("tags")) {
                    org.json.JSONArray tags = app.optJSONArray("tags");
                    if (tags != null) {
                        for (int i = 0; i < Math.min(tags.length(), 5); i++) {
