...
All requests are handled by broadcasting an intent to the `com.elitesoftware.elitewindowingcomponents.LAUNCH_WINDOW` action.

---

## Intent Specifications

**Action:** `com.elitesoftware.elitewindowingcomponents.LAUNCH_WINDOW`
**Target Package:** `com.elitesoftware.elitewindowingcomponents`
**Component (Receiver):** `com.elitesoftware.elitewindowingcomponents.WindowApiReceiver`
...
```bash
am broadcast -a com.elitesoftware.elitewindowingcomponents.LAUNCH_WINDOW \
    -n com.elitesoftware.elitewindowingcomponents/.WindowApiReceiver \
...
intent.setComponent(new ComponentName(
    "com.elitesoftware.elitewindowingcomponents", 
    "com.elitesoftware.elitewindowingcomponents.WindowApiReceiver"
));
...
2. **Action:** `com.elitesoftware.elitewindowingcomponents.LAUNCH_WINDOW`
3. **Package:** `com.elitesoftware.elitewindowingcomponents`
4. **Class:** `com.elitesoftware.elitewindowingcomponents.WindowApiReceiver`
